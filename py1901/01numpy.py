...
i = np.arange(10) #0 - 9까지 정수배열 numpy 버전 range
...
# # numpy로 생성한 배열중 1차원은 벡터, 2차원은 행렬, 3차원은 텐서
...
o = np.zeros((3,3))
print('원소가 0인 3 x 3 행렬\n', o)
p = np.ones((5))
print('원소가 1인 1 x 5 행렬\n', p)
...
schema = np.dtype([('name', 'S10'), ('age', 'i4'), ('height', 'f')]) # name, age, hiehgt 각각의 옆은 자료형
